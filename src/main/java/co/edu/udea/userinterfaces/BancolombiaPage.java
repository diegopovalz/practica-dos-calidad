...
public class BancolombiaPage extends PageObject {
    ...
    public static final Target CREDIT_INFORMATION_AMOUNT_TEXT = Target.the("Credit information text").locatedBy("/html/body/div[2]/div[2]/div/div[2]/div/div[2]/section/div[3]/div[2]/app-root/div/app-resultado-simulacion/section[1]/swiper/div/div[1]/div[1]/div/div[2]/div/h4");
}
